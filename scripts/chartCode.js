...
var cpuChartConfig = {
  ...
  options: {
    ...
    scales: {
      xAxes: [
        {
          gridLines: { color: color(chartColors.black).alpha(0.5).rgbString() },
          ticks: { fontcolor: chartColors.white },
          type: "realtime",
          realtime: {
            duration: 20000,
            refresh: 1000,
      ...
      yAxes: [
        {
          ...
          ticks: {
            ...
            max: 100,
            stepSize: 20,
            fontColor: color(chartColors.white).alpha(0.5).rgbString(),
          },
        },
      ],
    },
...
function initChart() {
  ...
  cpuChartConfig.options.title.fontColor = color(chartColors.white)
    .alpha(0.7)
    .rgbString();
  gpuChartConfig.options.title.fontColor = color(chartColors.white)
    .alpha(0.7)
    .rgbString();
  netChartConfig.options.title.fontColor = color(chartColors.white)
    .alpha(0.7)
    .rgbString();
  ramChartConfig.options.title.fontColor = color(chartColors.white)
    .alpha(0.7)
    .rgbString();
